...
public class Train extends Pane implements MapObject {
	...
	public Train(TrainInfo info) {
		...
		Location topLeft = new Location(40.8531617, -73.951866); // TODO move these constants lat lon to a constant
																	// class
		Location bottomRight = new Location(40.6373576, -73.9279334); // TODO move these constants lat lon to a constant
																		// class
		...
		ImageView lineIcon = new ImageView(
				getClass().getResource(this.info.getLine().getLineLetter() + ".png").toExternalForm());
